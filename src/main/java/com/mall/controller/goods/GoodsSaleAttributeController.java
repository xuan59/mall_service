...
import com.mall.service.goods.GoodsSaleAttributeService;
...
/**
 * 商品销售属性表(GoodsSaleAttribute)表控制层
 *
 * @author lx
 * @since 2021-06-29 20:32:02
 */
@RestController
@RequestMapping("/goodsSaleAttribute")
public class GoodsSaleAttributeController {
    /**
     * 服务对象
     */
    @Autowired
    private GoodsSaleAttributeService goodsSaleAttributeService;
