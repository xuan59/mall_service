...
import com.mall.service.goods.GoodsSpuInfoService;
...
/**
 * spu商品信息(GoodsSpuInfo)表控制层
 *
 * @author lx
 * @since 2021-06-29 20:33:23
 */
@RestController
@RequestMapping("/goodsSpuInfo")
public class GoodsSpuInfoController {
    /**
     * 服务对象
     */
    @Autowired
    private GoodsSpuInfoService goodsSpuInfoService;
